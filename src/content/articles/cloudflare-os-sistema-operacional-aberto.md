...
* [Site oficial do Cloudflare OS](https://os.cloudflare.app){:target="_blank"}
* [Artigo oficial no blog da Cloudflare](https://blog.cloudflare.com/cloudflare-os/){:target="_blank"}
* [Repositório no GitHub](https://github.com/cloudflare/os){:target="_blank"}
* [Documentação do Cloudflare Workers](https://developers.cloudflare.com/workers/){:target="_blank"}
* [Cloudflare AI Gateway](https://developers.cloudflare.com/ai-gateway/){:target="_blank"}
